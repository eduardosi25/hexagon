...
function probando(req, res){
  res.status(200).send({
    message: "Hola desde controlador de publicaciones"
  });
}
*/
        ...
        if (file_ext == 'jpg' || file_ext == 'png' || file_ext == 'jpeg' || file_ext == 'gif'){
          ...
          Publication.findOne({'user':req.user.sub, '_id':publicationId}).exec((err,publication)=>{
            ...
            if (publication){
              ...
              return removeFilesOfUploads(res, file_path, "No tienes permisos para actualizar la publicación");
            }
          });
